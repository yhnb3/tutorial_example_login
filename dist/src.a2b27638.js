...
},{"./text-field.template":"src/view/text-field.template.js"}],"src/utills/api.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getProfile = exports.getPost = exports.getAuthetication = void 0;

const getAuthetication = async data => {
  try {
...
exports.getAuthetication = getAuthetication;
...
class Login {
  ...
  #onSubmit = async e => {
    ...
    const result = await (0, _api.getAuthetication)(loginData); // const posts = await getPost(id, token)
...
},{"./login.template":"src/page/login.template.js","../view/text-field":"src/view/text-field.js","../utills/api":"src/utills/api.js","axios":"node_modules/axios/index.js"}],"src/index.js":[function(require,module,exports) {
"use strict";
...
},{"./page/login":"src/page/login.js"}],"../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
